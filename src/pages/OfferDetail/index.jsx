                    ...
                    <section>
                        ...
                        <div className="mission">
                            ...
                            <div className="d-flex direction-column align-start">
                                <div className="d-flex align-start">
                                    ...
                                    <p>Engagement de la communauté pour s'assurer qu'elle est soutenue et activement représentée en ligne</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Se concentrer sur la publication de contenu sur les médias sociaux</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                ...
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Rester à l'affût des tendances sur les plateformes de médias sociaux et suggérer des idées de contenu à l'équipe.</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                        ...
                        <div className="profil-wanted">
                            ...
                            <div className="d-flex direction-column align-start">
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Vous êtes passionné par le digital et pratiquez les principaux réseaux sociaux</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Vous avez le sens des relations humaines et du travail en équipe</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Vous avez un état d'esprit positif et  confiant et n'hésitez pas à apprendre de nouvelles compétences et à assumer des responsabilités supplémentaires</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Vous avez le sens du détail et de la créativité et maîtrisez Canva</p>
                                </div>
                                <div className="d-flex align-start">
                                    <Icon icon="simple-line-icons:check"/>
                                    <p>Vous avez déjà assuré des missions de Community Manager sur Instagram, Linkedin, Facebook, TikTok et X</p>
                                </div>
                            </div>
                        </div>
                    </section>
            ...
            <section className="grey offer-similar">
                <div className="container">
                    <div className="d-flex">
                        ...
                        <a className="link d-flex" href="">Toutes les offres <Icon icon="tabler:arrow-right" /></a>
                    </div>
