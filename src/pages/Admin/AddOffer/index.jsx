                        ...
                        <form method="post">
                            <div className={`${currentStep === 1 ? 'active' : 'd-none'}`}>
                                <div className="block">
                                    <div className="d-flex justify-start">
                                        ...
                                        <div>
                                            <input type="text" name="name-offer" id="name-offer" placeholder="ex: Assistant marketing"/>
                                ...
                                <div className="block">
                                    <div className="d-flex justify-start">
                                        ...
                                        <div>
                                            <input type="text" name="name-offer" id="name-offer" placeholder="Montants par mois"/>
                                ...
                                <div className="block">
                                    <div className="d-flex justify-start">
                                        ...
                                        <div>
                                            <select name="" id="">
                                                <option value="" disabled selected>Choisir le type de job</option>
                            ...
                            <div className={`${currentStep === 2 ? 'active' : 'd-none'}`}>
                                <div className="block">
                                    <div className="d-flex justify-start align-start">
                                        ...
                                        <textarea name="" id="" placeholder="Saissez votre texte ici"></textarea>
                                    </div>
                                </div>
                                <div className="block">
                                    <div className="d-flex justify-start align-start">
                                        <div>
                                            <h4>Mission</h4>
                                            <p>Décrivez les tâches, missions et responsabilités qui seront confiées au candidat</p>
                                        </div>
                                        <textarea name="" id="" placeholder="Saissez votre texte ici"></textarea>
                                    </div>
                                </div>
                                <div className="block">
                                    <div className="d-flex justify-start align-start">
                                        <div>
                                            ...
                                            <p>Décrivez les qualités du candidat idéal en termes de savoir-faire et de savoir-être.</p>
                                        </div>
                                        <textarea name="" id="" placeholder="Saissez votre texte ici"></textarea>
                                    </div>
                                </div>
                            ...
                            <div className="block">
                                    <div className="d-flex justify-start ">
                                        <div>
                                            <h4>Êtes-vous sûr ?</h4>
                                            <p>Vérifiez les différents champs avant de valider l'offre</p>
                                        </div>
                                        <input className="btn" type="submit" value="Je publie mon offre" />
                                    </div>
                                </div>
                                <div className="d-flex">
                                    <button className="btn" onClick={prevStep}>Etape précédente</button>
