      ...
      <div className="footer-content">
        ...
        <div className="footer-menu">
          <ul className="footer-menu--list">
            <li>
              <Link href="/" children="Accueil" />
            </li>
            <li>
              <Link href="/offers" children="Offres" />
            </li>
            <li>
              <Link href="/applications" children="Demandes" />
            </li>
            <li>
              <Link href="/companies" children="Entreprises" />
            </li>
            <li>
              <Link href="/students" children="Etudiants" />
            </li>
          </ul>
          <ul className="footer-menu--list">
            <li>
        ...
        <div className="footer-student">
          <div className="footer-student--title">
            ...
            <p>
              Recevez automatiquement par email les offres qui vous intéressent!
            </p>
          </div>
